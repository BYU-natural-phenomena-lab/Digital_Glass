...
namespace Walle.Eagle
{
    ...
    /// <summary>
    /// These are the rules that ship with EAGLE 7.2.0. Some manufacturers may require their own design rules.
    /// </summary>
    public class DefaultDesignRules : IDesignRules
    {
        public XElement RulesXml
        {
            get
            {
                return new XElement("designrules", new XAttribute("name", "default"),
                    new XElement("param", new XAttribute("name", "layerSetup"), new XAttribute("value", "(1*16)")),
                    new XElement("param", new XAttribute("name", "mtCopper"),
                        new XAttribute("value",
                            "0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm 0.035mm")),
                    new XElement("param", new XAttribute("name", "mtIsolate"),
                        new XAttribute("value",
                            "1.5mm 0.15mm 0.2mm 0.15mm 0.2mm 0.15mm 0.2mm 0.15mm 0.2mm 0.15mm 0.2mm 0.15mm 0.2mm 0.15mm 0.2mm")),
                    ...
                    new XElement("param", new XAttribute("name", "dpMaxLengthDifference"),
                        new XAttribute("value", "10mm")),
